...
include $(FLYFISH_TOP)/../../component/gstreamer/sme.mk
endif
...
include $(FLYFISH_TOP)/component/SystemTimeSetting/SystemTimeSetting.mk
...
#include $(FLYFISH_TOP)/component/TosPlayer/hidvbplayer/libhi_dvbplayer.mk
#include $(FLYFISH_TOP)/component/TosPlayer/demux_dvb/libgstdemux.mk
include $(FLYFISH_TOP)/tools/linux/input/input.mk
